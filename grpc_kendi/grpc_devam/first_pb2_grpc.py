...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ChattyClientSaysHello = channel.stream_unary(
                ...
                request_serializer=first__pb2.HelloRequest.SerializeToString,
                response_deserializer=first__pb2.DelayedReply.FromString,
                _registered_method=True)
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ChattyClientSaysHello': grpc.stream_unary_rpc_method_handler(
                    ...
                    request_deserializer=first__pb2.HelloRequest.FromString,
                    response_serializer=first__pb2.DelayedReply.SerializeToString,
            ),
...
class Greeter(object):
    ...
    def SayHello(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            first__pb2.HelloReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ChattyClientSaysHello(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            '/greet.Greeter/ChattyClientSaysHello',
            first__pb2.HelloRequest.SerializeToString,
            first__pb2.DelayedReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
